...
public class J0912_05 {
	...
	public static void main(String[] args) {
		...
		p1.pName = "led 55inch";
		p1.price = 50;
		Product p2 = new Product("led 60inch", 100);

		Product p3 = new Product("led 65inch",65);
	
		Product p4 = new Product("led 70inch",300);

		Product p5 = new Product("led 80inch",400);

		Product p6 = new Product("led 90inch",500);
		...
		System.out.println("---------------------------");
		System.out.println("p6번호 : " + p6.serialNo);
		System.out.println("p6제품이름 : " + p6.pName);
		System.out.println("p6가격 : " + p6.price);
